                ...
                for (var E, S = t.slidesPerColumn, C = x / S, M = Math.floor(d / t.slidesPerColumn), k = 0; k < d; k += 1) {
                    ...
                    if ("none" !== P.css("display")) {
                        if ("auto" === t.slidesPerView) {
                            ...
                            T = t.roundLengths ? e.isHorizontal() ? P.outerWidth(!0) : P.outerHeight(!0) : e.isHorizontal() ? parseFloat(I.getPropertyValue("width")) + parseFloat(I.getPropertyValue("padding-left")) + parseFloat(I.getPropertyValue("padding-right")) + parseFloat(I.getPropertyValue("margin-left")) + parseFloat(I.getPropertyValue("margin-right")) : parseFloat(I.getPropertyValue("height")) + parseFloat(I.getPropertyValue("padding-top")) + parseFloat(I.getPropertyValue("padding-bottom")) + parseFloat(I.getPropertyValue("margin-top")) + parseFloat(I.getPropertyValue("margin-bottom")),
    ...
    var H = {
      ...
      , q = {
        ...
        onGestureChange: function(e) {
            ...
            i.$imageEl && 0 !== i.$imageEl.length && (a.scale = F.gestures ? e.scale * a.currentScale : i.scaleMove / i.scaleStart * a.currentScale,
