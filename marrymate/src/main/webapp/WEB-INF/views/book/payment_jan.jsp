...
function requestPay() {   
	   ...
	   var usePoint=parseInt(strUsePoint);
		...
		sendRequest('notHallJanPayment.do',param,'POST',payResult);
		...
		<div class="janPay_container">
			...
			<div class="janItem_box">
				...
				<table class="janItem_table">
                  ...
                  <tr>
                     <td></td>
                     <td align="right"><span class="small_text">가격</span>&nbsp;&nbsp;&nbsp;<span class="itemPrice">${comDto.pay }</span> 원</td>
                  </tr>
                  <tr>
                     <td colspan="2"><span id="bk_cname" class="bold_text">${comDto.cname }</span> (<span id="bk_kind">${comDto.kind }</span>)</td>
                     <td align="right">
				...
				<div class="usePoint_box">
	               <table class="usePoint_table">
	                  <tr>
	                     ...
	                     <td class="bold_text"><span class="allItemPrice">${comDto.pay }</span> 원</td>
	                  </tr>
	                  <tr>
	                     <td>보유포인트</td>
